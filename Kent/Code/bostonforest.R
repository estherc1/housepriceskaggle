...
tree.pred
mean((tree.pred - treehouses.test$SalePrice)^2)#MSE 0.03832355 Test
...
prune.houses = prune.tree(tree.houses, best = 2)
par(mfrow = c(1, 1))
plot(prune.houses)
...
prune.pred
mean((prune.pred - treehouses.test$SalePrice)^2)#MSE 0.0841954
...
prune.pred4
mean((prune.pred4 - treehouses.test$SalePrice)^2)#MSE 0.05118822
